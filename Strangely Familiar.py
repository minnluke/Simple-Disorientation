...
#Minn Maung 03.20.2022
#Digital Twin

rs.EnableRedraw(False)

###creating cube
def cube (start_point): 
    n = rs.GetReal("Please provide the volume of room")
    rect = rs.AddRectangle(start_point,n,n)
    rs.HideObject(rect)
...
###creating a surface around a center point
def center_point_of_surface ():
    polySrf = boxList[-1]
...
###duplicate the surfaces around a center point
def duplicating_surface_around_center_point ():
